...
export const RegistrationFormReact = () => {
  ...
  const handleInputChange = (e) => {
    ...
    setUser((prev) =>({ ...prev, [name]: value })); //[] is used to pass dynamic value ,if name jo milega vo pahle se hoga user me tohuski value update ho jaygei otherwise new element add ho jayega
  };
